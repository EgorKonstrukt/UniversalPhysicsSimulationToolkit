...
class InputHandler:
    def __init__(self, game_app, gizmos_manager, debug_manager, undo_redo_manager):
        ...
        self.joint_tools = ["Spring", "Pivot", "Rigid"]
    ...
    #     if self.key_z_pressed and (pygame.time.get_ticks() - self.key_z_hold_start_time) > Config.KEY_HOLD_TIME:
    #         self.undo_action()
    #
    # def undo_action(self):
    #     last_body = self.app.physics_manager.get_last_body()
    #     if last_body:
    #         self.app.physics_manager.remove_body(last_body)
    #         synthesizer.play_frequency(200, duration=0.01, waveform='triangle', volume=0.15)
    #
    #
