...
from UPST.script_system_main import integrate_script_system
...
class Application:
    ...
    def __init__(self):
        ...
        pygame.display.set_caption(f"{Config.VERSION}")
        ...
        self.camera = Camera(self, Config.SCREEN_WIDTH, Config.SCREEN_HEIGHT, self.screen)
